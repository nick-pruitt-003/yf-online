...
export default function GeneralTab({ handle, canEdit }: Props) {
  ...
  return (
    <Box display="flex" flexDirection="column" gap={3} maxWidth={700}>
      <Card>
        <CardContent>
          <Typography variant="h6" gutterBottom>Tournament Info</Typography>
      ...
      <Card>
        <CardContent>
          <Typography variant="h6" gutterBottom>Player Tracking</Typography>
      ...
      {t.phases.length > 0 && (
        <Card>
          <CardContent>
            <Typography variant="h6" gutterBottom>Packet Names</Typography>
